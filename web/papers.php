...
<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="paperlist">
  ...
  <?php
    ...
    add_paperlistitem(
      ...
      "Yi Sun (Institute of Computing Technology, Chinese Academy of Sciences), Xiaoqi Yin, Junchen Jiang, and Vyas Sekar (CMU), Fuyuan Lin and Nanshu Wang (ICT/CAS), Tao Liu (iQIYI), and Bruno Sinopoli (CMU)");
    ...
    add_paperlistitem(
      ...
      "Ryan Beckett (Princeton University), Ratul Mahajan and Jitu Padhye (Microsoft Research), Todd Millstein (University of California, Los Angeles), and David Walker (Princeton University)");
