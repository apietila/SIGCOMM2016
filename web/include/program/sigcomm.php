...
<?php
      ...
      tprog_add_item("Packet Transactions: High-Level Programming for Line-Rate Switches", "", "Anirudh Sivaraman (MIT CSAIL), Alvin Cheung (University of Washington, Seattle), Mihai Budiu (VMWare Research), Changhoon Kim (Barefoot Networks), Mohammad Alizadeh (MIT CSAIL), Hari Balakrishnan (MIT CSAIL), George Varghese (Microsoft Research), Nick McKeown (Stanford University), Steve Licking (Barefoot Networks)", "", "", "", "prog-tuesday");
      tprog_add_item("SNAP: Stateful Network-Wide Abstractions for Packet Processing", "", "Mina Tahmasbi Arashloo (Princeton University), Yaron Koral (Princeton University), Michael Greenberg (Pomona College), Jennifer Rexford (Princeton University), David Walker (Princeton University)", "", "", "", "prog-tuesday");
      tprog_add_item("Programmable Packet Scheduling at Line Rate", "", "Anirudh Sivaraman (MIT CSAIL), Suvinay Subramanian (MIT CSAIL), Mohammad Alizadeh (MIT CSAIL), Sharad Chole (Cisco Systems), Shang-Tse Chuang (Cisco Systems), Anurag Agrawal (Barefoot Networks), Hari Balakrishnan (MIT CSAIL), Tom Edsall (Cisco Systems), Sachin Katti (Stanford University), Nick McKeown (Stanford University)", "", "", "", "prog-tuesday");
      ...
      tprog_add_item("Evolve or Die: High-Availability Design Principles Drawn from Google's Network Infrastructure", "", "Ramesh Govindan (Google / USC), Ina Minei (Google), Mahesh Kallahalla (Google), Bikash Koley (Google), Amin Vahdat (Google)", "", "", "", "prog-tuesday");
      tprog_add_item("Dynamic Pricing and Traffic Engineering for Timely Inter-Datacenter Transfers", "", "Virajith Jalaparti (Microsoft), Ivan Bliznets (St. Petersburg Academic University), Srikanth Kandula (Microsoft), Brendan Lucier (Microsoft), Ishai Menache (Microsoft)", "", "", "", "prog-tuesday");
      ...
      tprog_add_item("One Sketch to Rule Them All: Rethinking Network Flow Monitoring with UnivMon", "", "Zaoxing Liu (Johns Hopkins University), Antonis Manousis (Carnegie Mellon University), Gregory Vorsanger (Johns Hopkins University), Vyas Sekar (Carnegie Mellon University), Vladimir Braverman (Johns Hopkins University)", "", "", "", "prog-tuesday");
      ...
      tprog_add_item("CODA: Toward Automatically Identifying and Scheduling Coflows in the Dark", "", "Hong Zhang (Hong Kong University of Science and Technology), Li Chen (Hong Kong University of Science and Technology), Bairen Yi (Hong Kong University of Science and Technology), Kai Chen (Hong Kong University of Science and Technology), Mosharaf Chowdhury (University of Michigan), Yanhui Geng (Huawei Noah's Ark Lab)", "", "", "", "prog-wednesday");
      tprog_add_item("Scheduling Mix-flows in Commodity Datacenters with Karuna", "", "Li Chen (Hong Kong University of Science and Technology), Kai Chen (Hong Kong University of Science and Technology), Wei Bai (Hong Kong University of Science and Technology), Mohammad Alizadeh (MIT)", "", "", "", "prog-wednesday");
      tprog_add_item("NUMFabric: Fast and Flexible Bandwidth Allocation in Datacenters", "", "Kanthi Nagaraj (Stanford University), Dinesh Bharadia (Stanford University), Hongzi Mao (M.I.T), Sandeep Chinchali (Stanford University), Mohammad Alizadeh (M.I.T.), Sachin Katti (Stanford University)", "", "", "", "prog-wednesday");
      ...
      tprog_add_item("RDMA over Commodity Ethernet at Scale", "", "Chuanxiong Guo (Microsoft Research), Haitao Wu (Microsoft), Zhong Deng (Microsoft), Gaurav Soni (Microsoft), Jianxi Ye (Microsoft), Jitu Padhye (Microsoft Research), Marina Lipshteyn (Microsoft)", "", "", "", "prog-wednesday");
      ...
      tprog_add_item("Virtualized Congestion Control", "", "Bryce Cronkite-Ratcliff (VMware / Stanford), Aran Bergman (Technion), Shay Vargaftik (Technion), Madhusudhan Ravi (VMware), Nick McKeown (Stanford), Ittai Abraham (VMware), Isaac Keslassy (VMware / Stanford / Technion)", "", "", "", "prog-wednesday");
      ...
      tprog_add_item("Fast Control Plane Analysis Using an Abstract Representation", "", "Aaron Gember-Jacobson (University of Wisconsin-Madison), Raajay Viswanathan (University of Wisconsin-Madison), Aditya Akella (University of Wisconsin-Madison), Ratul Mahajan (Microsoft Research)", "", "", "", "prog-wednesday");
      tprog_add_item("Symnet: scalable symbolic execution for modern networks", "", "Radu Stoenescu (University Politehnica of Bucharest), Matei Popovici (University Politehnica of Bucharest), Lorina Negreanu (University Politehnica of Bucharest), Costin Raiciu (University Politehnica of Bucharest)", "", "", "", "prog-wednesday");
      ...
      tprog_add_item("Enabling Practical Backscatter Communication for On-body Sensors", "", "Pengyu Zhang (University of Massachusetts Amherst), Mohammad Rostami (University of Massachusetts Amherst), Pan Hu (University of Massachusetts Amherst), Deepak Ganesan (University of Massachusetts Amherst)", "", "", "", "prog-thursday");
      ...
      tprog_add_item("Eliminating Channel Feedback in Next-Generation Cellular Networks", "", "Deepak Vasisht (MIT), Swarun Kumar (CMU), Hariharan Rahul (MIT), Dina Katabi (MIT)", "", "", "", "prog-thursday");
      tprog_add_item("Real-time Distributed MIMO Systems", "", "Ezzeldin Hamed (Massachusetts Institute of Technology), Hariharan Rahul (Massachusetts Institute of Technology), Mohammed A. Abdelghany (Massachusetts Institute of Technology), Dina Katabi (Massachusetts Institute of Technology)", "", "", "", "prog-thursday");
      ...
      tprog_add_item("Robotron: Top-down Network Management at Facebook Scale", "", "Yu-Wei Eric Sung (Facebook), Xiaozheng Tie (Facebook), Starsky H.Y. Wong (Facebook), Hongyi Zeng (Facebook)", "", "", "", "prog-thursday");
      tprog_add_item("Taking the Blame Game out of Data Centers Operations with NetPoirot", "", "Behnaz Arzani (University of Pennsylvania), Selim Ciraci (Microsoft), Boon Thau Loo (University of Pennsylvania), Assaf Schuster (Technion - Israel Institute of Technology), Geoff Outhred (Microsoft)", "", "", "", "prog-thursday");
      tprog_add_item("Globally Synchronized Time via Datacenter Networks", "", "Ki Suh Lee (Cornell University), Han Wang (Cornell University), Vishal Shrivastav (Cornell University), Hakim Weatherspoon (Cornell University)", "", "", "", "prog-thursday");
      ...
      tprog_add_item("An Internet-Wide Analysis of Traffic Policing", "", "Tobias Flach (University of Southern California / Google), Pavlos Papageorge (Google), Andreas Terzis (Google), Luis Pedrosa (University of Southern California), Yuchung Cheng (Google), Tayeb Karim (Google), Ethan Katz-Bassett (University of Southern California), Ramesh Govindan (University of Southern California / Google)", "", "", "", "prog-thursday");
      tprog_add_item("Neutral Net Neutrality", "", "Yiannis Yiakoumis (Stanford University), Sachin Katti (Stanford University), Nick McKeown (Stanford University)", "", "", "", "prog-thursday");
      tprog_add_item("The Deforestation of L2", "", "James McCauley (UC Berkeley / ICSI), Mingjie Zhao (UESTC / ICSI), Ethan J. Jackson (UC Berkeley), Barath Raghavan (ICSI), Sylvia Ratnasamy (UC Berkeley / ICSI), Scott Shenker (UC Berkeley / ICSI)", "", "", "", "prog-thursday");
