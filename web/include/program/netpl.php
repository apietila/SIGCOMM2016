<ul class="program" data-role="listview" data-inset="true" data-theme="d" data-dividertheme="a">
    ...
    <!-- nate foster -->
    <div data-role="collapsible" class="keynote-navgroup">
      <h4><p class="keynote-header">The Next 700 Network Programming Languages</p><p class="keynote-speaker">Nate Foster <i>(Cornell University</i>)</p></h4>
      <ul data-role="listview" data-inset="false">
        <li data-icon="false"><p><img class="keynote-photo" src="images/program/netpl/nate-foster.png"/><b>Abstract: </b>Specification and verification of computer networks has become a reality in recent years, with the emergence of domain-specific programming languages and automated verification tools. But the design of these languages and tools has been largely ad hoc, driven more by the needs of applications and the capabilities of hardware than by any foundational principles. This talk will present NetKAT, a language for programming networks based on a well-studied mathematical foundation, Kleene Algebra with Tests (KAT). The talk will describe the design of the language, its semantic underpinnings, and extensions with features to support stateful and probabilistic programming.</p>
        <p>&nbsp;</p><p>NetKAT is joint work with colleagues at Cornell, Facebook, Inhabited Type, Princeton, Samsung, UCL, and UMass Amherst.</p></li>
        <li data-icon="false"><p><b>Bio: </b>Nate Foster is an Assistant Professor of Computer Science at Cornell University. The goal of his search is developing programming languages and tools for building reliable systems. He received a PhD in Computer Science from theUniversity of Pennsylvania in 2009, an MPhil in History and Philosophy of Science from Cambridge University in 2008, and a BA in Computer Science from Williams College in 2001. His awards include a Sloan Research Fellowship, an NSF CAREER Award, a Most Influential POPL Paper Award, a Tien &#39;72 Teaching Award, a Google Research Award, a Yahoo! Academic Career Enhancement Award, and the Morris and Dorothy Rubinoff Award.</p></li>
      </ul>
    </div>
    ...
    <div data-role="collapsible" class="keynote-navgroup">
      <h4><p class="keynote-header">Interactive Query for Dynamic Network Analytics</p><p class="keynote-speaker">Haoyu Song <i>(Huawei Technologies)</i></p></h4>
      <ul data-role="listview" data-inset="false">
        <li data-icon="false"><p><img class="keynote-photo" src="images/program/netpl/haoyu-song.jpg"/><b>Abstract: </b>Network data plane needs to be interactively programmed in order to support Dynamic Network Analytics (DNA). We envision the high level DNA applications can be break down into a set of queries and the queries can be further compiled into incremental configurations to the data plane. We emphasize the need to define standard DNA APIs and/or query language for DNA system.</p></li>
        <li data-icon="false"><p><b>Bio: </b>Haoyu Song is a principal architect at Huawei Technologies. He is a leading researcher on SDN programmable data plane. His current research interests span all aspects of the SDN/NFV ecosystem. He was a researcher at Bell Labs, Alcatel-Lucent before joining Huawei. He hold a doctoral degree in computer engineering from Washington University in St. Louis.</p></li>
      </ul>
    </div>
    ...
    <div data-role="collapsible" class="keynote-navgroup">
      <h4><p class="keynote-header">Verifying Reachability in Networks with Mutable Datapaths</p><p class="keynote-speaker">Aurojit Panda <i>(UC Berkeley)</i></p></h4>
      <ul data-role="listview" data-inset="false">
        <li data-icon="false"><p><img class="keynote-photo" src="images/program/netpl/aurojit-panda.jpg"/><b>Abstract: </b>Recent work has made great progress in verifying the forwarding correctness of networks. However, these approaches cannot be used to verify networks containing middleboxes, such as caches and firewalls, whose forwarding behavior depends on previously observed traffic. We explore how to verify reachability properties for networks that include such "mutable datapath" elements. We want our verification results to hold not just for the given network, but also in the presence of failures. The main challenge lies in scaling the approach to handle large and complicated networks, We address by developing and leveraging the concept of slices, which allow network-wide verification to only require analyzing small portions of the network. We show that with slices the time required to verify an invariant on many production networks is independent of the size of the network itself.</p></li>
        <li data-icon="false"><p><b>Bio: </b>Aurojit Panda is a PhD candidate at UC Berkeley advised by Scott Shenker. His research largely focuses on how to simplify developing and deploying new network services.</p></li>
      </ul>
    </div>
