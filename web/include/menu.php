<div class="leftnav" role="panel" data-position="left" data-display="overlay" data-theme="a">
  ...
  <ul data-role="listview" data-inset="true" data-theme="a" data-divider-theme="a">
    <li data-icon="false">
      <a <?php if ($mypage=="index.php") echo('class="navselected"') ?> href="index.php">Home</a>
    </li>
    <li data-icon="false">
      <a <?php if ($mypage=="local.php") echo('class="navselected"') ?> href="local.php">Local Information</a>
    </li>
    <li data-icon="false">
      <a <?php if ($mypage=="organization.php") echo('class="navselected"') ?> href="organization.php">Organization Committee</a>
    </li>
  </ul>
