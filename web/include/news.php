<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="datetbl">
  <?php add_dateitem("August 7, 2016", "Follow SIGCOMM 2016 news and main conference program on your mobile device using the <a href=\"https://www.mconference.com.br/\">mConference</a> event app! Download from <a href=\"https://itunes.apple.com/us/app/mconference/id1051141041?l=pt&ls=1&mt=8\">AppStore</a> or <a href=\"https://play.google.com/store/apps/details?id=felipe.saraiva.com.mconference2\">Google Play</a>, and add ACM SIGCOMM 2016 from the conference list.") ?>
  <?php add_dateitem("August 3, 2016", "The <a href=\"http://dl.acm.org/citation.cfm?id=2934872\">ACM SIGCOMM 2016 conference proceedings</a> are now available in the ACM Digital Library! We also included links to papers in the main conference program, posters, and demos.") ?>
  <?php add_dateitem("July 25, 2016", "We are delighted to announce that <b>Jim Kurose</b> (University of Massachusetts, Amherst) is the 2016 SIGCOMM Lifetime Achievement Award winner! Jim will be giving the SIGCOMM <a href=\"program.php\">opening keynote speech</a> on Tuesday, 23rd. More details will be online soon!") ?>
  ...
  <?php add_dateitem("July 15, 2016", "The <a href=\"posterprogram.php\">Poster</a> and <a href=\"demoprogram.php\">Demo</a> sessions programs online") ?>
  ...
  <?php add_dateitem("April 24, 2016", "Attention graduate students: Call for ACM SIGCOMM 2016 &quot;<a href=\"mentoring.php\">mentoring moments</a>&quot; is online! Please visit the page for further details and how to apply") ?>
  <?php add_dateitem("April 22, 2016", "Call for <a href=\"n2women.php\">N2Women Young Researcher Fellowship</a> online") ?>
  ...
  <?php add_dateitem("March 29, 2016", "<a href=\"industrialdemos.php\">Call for Industrial Demos</a> is online") ?>
  <?php add_dateitem("March 23, 2016", "Updated <a href=\"advisory.php\">Advice for Travellers</a> information is available") ?>
  <?php add_dateitem("March 18, 2016", "<a href=\"hotmiddlebox.php\">HotMiddlebox</a>, <a href=\"qoe.php\">Internet-QoE</a> and <a href=\"lancomm.php\">LANCOMM</a> workshops paper registration and submission deadlines extended") ?>
  <?php add_dateitem("March 14, 2016", "Relocation to Florian&oacute;polis announced") ?>
  <?php add_dateitem("March 10, 2016", "GAIA workshop <a href=\"gaia.php\">paper registration and submission deadlines</a> extended") ?>
  <?php /* add_dateitem("February 26, 2016", "We would like to consult the SIGCOMM community and prospective attendees about your plans to attend the conference this year. Please visit the <a href=\"poll.php\">poll page under the local information section</a> for further information") */ ?>
  <?php add_dateitem("February 25, 2016", "NetPL workshop <a href=\"netpl.php\">call for participation and presentations</a> online") ?>
  <?php add_dateitem("February 12, 2016", "<a href=\"advisory.php\">Advice for Travellers</a> to SIGCOMM'16 is online") ?>
  ...
  <?php add_dateitem("January 5, 2016", "Workshop dates announced") ?>
