...
<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="tbl">
  ...
  <?php
    ...
    add_listitem("Hitesh Ballani", "Microsoft Research Cambridge, UK", "http://research.microsoft.com/en-us/um/people/hiballan/");
    ...
    add_listitem("Ranjita Bhagwan", "Microsoft Research, India", "http://research.microsoft.com/en-us/people/bhagwan/");
    add_listitem("Fabi&aacute;n Bustamante", "Northwestern University, USA", "http://www.cs.northwestern.edu/~fabianb/");
    add_listitem("Nandita Dukkipati", "Google Research, USA", "http://research.google.com/pubs/author39115.html");
    ...
    add_listitem("Srikanth Kandula", "Microsoft Research Redmond, USA", "http://research.microsoft.com/en-us/um/people/srikanth/home.html");
    ...
    add_listitem("Ratul Mahajan", "Microsoft Research Redmond, USA", "http://research.microsoft.com/en-us/um/people/ratul/");
    ...
    add_listitem("Jeff Mogul", "Google Research, USA", "http://research.google.com/pubs/JeffreyMogul.html");
    add_listitem("Andrew Moore", "University of Cambridge, UK", "http://www.cl.cam.ac.uk/~awm22/");
    add_listitem("Radhika Mysore", "Google Research, USA", "http://research.google.com/pubs/RadhikaNiranjanMysore.html");
    add_listitem("Dave Oran", "Cisco, USA", "http://www.cisco.com/");
    add_listitem("Venkat Padmanabhan", "Microsoft Research, India", "http://research.microsoft.com/en-us/people/padmanab/");
    ...
    add_listitem("Ming Zhang", "Microsoft Research Redmond, USA", "http://research.microsoft.com/en-us/people/mzh/");
